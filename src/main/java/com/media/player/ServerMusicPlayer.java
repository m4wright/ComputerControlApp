...
import com.media.player.MusicPlayer.MusicPlayerInterface;
...
public class ServerMusicPlayer implements MusicPlayerInterface
{
    private final String baseUrl;


    public ServerMusicPlayer(String baseUrl)
    {
